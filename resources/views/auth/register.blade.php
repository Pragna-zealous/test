                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       {{-- <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="col-md-10">
                                <input id="notification" type="checkbox" value=1 class="" name="notification" ><span> I want to subscribe email and whatsapp to get latest updates from We/Can</span>
                            </div>
                        </div>
